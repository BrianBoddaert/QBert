...
void dae::InputManager::ControllerInput()
{
    DWORD dwResult;
...
bool dae::InputManager::IsPressed(const ControllerButton& button, const std::unique_ptr<Controller>& controller) const
{
...
bool dae::InputManager::IsPressed(const BYTE& trigger) const
{
...
bool dae::InputManager::IsPressed(const SHORT& analogMovement,bool up) const
{
    if (up)
    {
